...
/******/ 	return __webpack_require__(__webpack_require__.s = "./functions/users/deleteUser/deleteUser.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./functions/users/deleteUser/deleteFromDynamoDB.js":
/*!**********************************************************!*\
  !*** ./functions/users/deleteUser/deleteFromDynamoDB.js ***!
  \**********************************************************/
/*! exports provided: deleteFromDynamoDB, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "deleteFromDynamoDB", function() { return deleteFromDynamoDB; });
/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! source-map-support/register */ "source-map-support/register");
/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(source_map_support_register__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils */ "./functions/utils.js");
...
const deleteFromDynamoDB = async userID => {
  // DynamoDB operation
  const params = {
...
/***/ "./functions/users/deleteUser/deleteFromMysqlDB.js":
/*!*********************************************************!*\
  !*** ./functions/users/deleteUser/deleteFromMysqlDB.js ***!
  \*********************************************************/
/*! exports provided: deleteFromMysqlDB, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "deleteFromMysqlDB", function() { return deleteFromMysqlDB; });
/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! source-map-support/register */ "source-map-support/register");
/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(source_map_support_register__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _connect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../connect */ "./functions/connect.js");


const deleteFromMysqlDB = id => {
  // Mysql operation
...
/***/ "./functions/users/deleteUser/deleteUser.js":
/*!**************************************************!*\
  !*** ./functions/users/deleteUser/deleteUser.js ***!
  \**************************************************/
/*! exports provided: deleteUser, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! source-map-support/register */ "source-map-support/register");
/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(source_map_support_register__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _deleteFromMysqlDB__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./deleteFromMysqlDB */ "./functions/users/deleteUser/deleteFromMysqlDB.js");
/* harmony import */ var _deleteFromDynamoDB__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./deleteFromDynamoDB */ "./functions/users/deleteUser/deleteFromDynamoDB.js");
...
const deleteUser = async event => {
  ...
  if (_utils__WEBPACK_IMPORTED_MODULE_3__["IS_OFFLINE"] === "true") {
    return Object(_deleteFromMysqlDB__WEBPACK_IMPORTED_MODULE_1__["deleteFromMysqlDB"])(id);
  }

  return Object(_deleteFromDynamoDB__WEBPACK_IMPORTED_MODULE_2__["deleteFromDynamoDB"])(id);
};
/* harmony default export */ __webpack_exports__["default"] = ({
  deleteUser
});

...
/******/ 	return __webpack_require__(__webpack_require__.s = "./functions/users/getUser/getUser.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./functions/users/getUser/getFromDynamoDB.js":
/*!****************************************************!*\
  !*** ./functions/users/getUser/getFromDynamoDB.js ***!
  \****************************************************/
/*! exports provided: getFromDynamoDB, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFromDynamoDB", function() { return getFromDynamoDB; });
/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! source-map-support/register */ "source-map-support/register");
/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(source_map_support_register__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils */ "./functions/utils.js");
...
const getFromDynamoDB = async userID => {
  // DynamoDB operation
  const params = {
...
/***/ "./functions/users/getUser/getFromMysqlDB.js":
/*!***************************************************!*\
  !*** ./functions/users/getUser/getFromMysqlDB.js ***!
  \***************************************************/
/*! exports provided: getFromMysqlDB, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFromMysqlDB", function() { return getFromMysqlDB; });
/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! source-map-support/register */ "source-map-support/register");
/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(source_map_support_register__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _connect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../connect */ "./functions/connect.js");


const getFromMysqlDB = id => {
  // Mysql operation
...
/***/ "./functions/users/getUser/getUser.js":
/*!********************************************!*\
  !*** ./functions/users/getUser/getUser.js ***!
  \********************************************/
...
/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! source-map-support/register */ "source-map-support/register");
/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(source_map_support_register__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _getFromMysqlDB__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getFromMysqlDB */ "./functions/users/getUser/getFromMysqlDB.js");
/* harmony import */ var _getFromDynamoDB__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getFromDynamoDB */ "./functions/users/getUser/getFromDynamoDB.js");
...
const getUser = async event => {
  ...
  if (_utils__WEBPACK_IMPORTED_MODULE_3__["IS_OFFLINE"] === "true") {
    return Object(_getFromMysqlDB__WEBPACK_IMPORTED_MODULE_1__["getFromMysqlDB"])(userID);
  }

  return Object(_getFromDynamoDB__WEBPACK_IMPORTED_MODULE_2__["getFromDynamoDB"])(userID);
};
/* harmony default export */ __webpack_exports__["default"] = ({
  getUser
});
